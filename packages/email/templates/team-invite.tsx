...
export const TeamInviteEmailTemplate = ({
  ...
  const previewText = `Aceptar invitación para unirte a un equipo en Design Signature`;
            ...
            <Container className="mx-auto mb-2 mt-8 max-w-xl rounded-lg border border-solid border-slate-200 p-2 backdrop-blur-sm">
              ...
              <Section className="p-2 text-slate-500">
                <Text className="text-center text-lg font-medium text-black">
                  Ingresar al equipo {teamName} en Design Signature
                </Text>

                <Text className="my-1 text-center text-base">
                Has sido invitado a unirte al siguiente equipo
                </Text>
